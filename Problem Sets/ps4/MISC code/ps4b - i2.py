    ...
    def build_shift_dict(self, shift):
        ...
        while i < len(letter_keys): 
               if letter_keys[i] in lowerCase:
                   if i+shift > 25: 
                       shift_dict.update({letter_keys[i]:letter_keys[shift]})
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        '''
        #shift = 26 - i, with i not being more than 25
        word_count = 0 
        new_word_count = 0 
        ...
        while i < 26:
            print("While i < 26:")
            decrypted_message = self.apply_shift(shift-i)
...
#cipher_message = CiphertextMessage("Have you heard the good news?")
...
#
    ...
    message = Message('Have you heard the good news?')
    message_text = message.get_message_text()
    #print(message_text)
    #shift_dict = message.build_shift_dict(25)
    
    #print(shift_dict)
    #encrypted_message = message.apply_shift(24)
    #print(encrypted_message)
    cipher_text = CiphertextMessage(plaintext.get_message_text_encrypted())
    my_tuple = cipher_text.decrypt_message()
